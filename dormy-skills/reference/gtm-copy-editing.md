...
> Adapted from upstream `marketingskills/copy-editing` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/copy-editing/`.
