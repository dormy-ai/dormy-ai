...
> Adapted from upstream `marketingskills/site-architecture` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/site-architecture/`.
