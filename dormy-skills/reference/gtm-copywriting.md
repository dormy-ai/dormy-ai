...
> Adapted from upstream `marketingskills/copywriting` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/copywriting/`.
