...
> Adapted from upstream `marketingskills/customer-research` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/customer-research/`.
