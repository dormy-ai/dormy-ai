...
> Adapted from upstream `marketingskills/referral-program` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/referral-program/`.
