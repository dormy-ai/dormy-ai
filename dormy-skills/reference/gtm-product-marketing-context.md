---
name: gtm-product-marketing-context
description: |
  ...
  configured, this skill calls `mcp_dormy_memory_recall(tags=['gtm', 'icp'])`
...
> Adapted from upstream `marketingskills/product-marketing-context` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/product-marketing-context/`.
...
1. `mcp_dormy_memory_recall(query="<user's specific prompt>", tags=['gtm', 'icp'])`
