...
> Adapted from upstream `marketingskills/sales-enablement` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/sales-enablement/`.
