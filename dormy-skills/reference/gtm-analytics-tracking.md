...
> Adapted from upstream `marketingskills/analytics-tracking` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/analytics-tracking/`.
