...
> Adapted from upstream `marketingskills/ab-test-setup` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/ab-test-setup/`.
