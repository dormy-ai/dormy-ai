...
> Adapted from upstream `marketingskills/signup-flow-cro` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/signup-flow-cro/`.
