...
> Adapted from upstream `marketingskills/programmatic-seo` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/programmatic-seo/`.
