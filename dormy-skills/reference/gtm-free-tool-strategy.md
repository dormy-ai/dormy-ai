...
description: |
  ...
  configured, this skill calls `mcp_dormy_memory_recall(tags=['gtm', 'growth'])`
...
> Adapted from upstream `marketingskills/free-tool-strategy` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/free-tool-strategy/`.
...
1. `mcp_dormy_memory_recall(query="<user's specific prompt>", tags=['gtm', 'growth'])`
