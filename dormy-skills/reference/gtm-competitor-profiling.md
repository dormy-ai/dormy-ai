...
> Adapted from upstream `marketingskills/competitor-profiling` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/competitor-profiling/`.
