---
name: gtm-directory-submissions
description: |
  ...
  configured, this skill calls `mcp_dormy_memory_recall(tags=['gtm', 'distribution'])`
...
> Adapted from upstream `marketingskills/directory-submissions` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/directory-submissions/`.
...
1. `mcp_dormy_memory_recall(query="<user's specific prompt>", tags=['gtm', 'distribution'])`
