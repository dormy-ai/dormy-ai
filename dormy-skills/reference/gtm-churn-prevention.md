...
> Adapted from upstream `marketingskills/churn-prevention` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/churn-prevention/`.
