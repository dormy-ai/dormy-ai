...
> Adapted from upstream `marketingskills/onboarding-cro` (MIT). Source preserved
> verbatim under `dormy-skills/sources/marketingskills/skills/onboarding-cro/`.
